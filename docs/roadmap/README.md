...
| 2 | [phase-2-retention.md](phase-2-retention.md) | Private tracker, Comeback, digest, "not alone", notifications | ⬜ gated |
| 3 | [phase-3-depth-and-growth.md](phase-3-depth-and-growth.md) | Discovery, follow, notifications, **interview-experience SEO hub** | ⬜ gated |
...
- **No jobs board, networking graph, or polished comp calculator** — that's LinkedIn/Grapevine.
...
| **Notifications & email** | — | in-app + weekly digest (Resend) | full prefs + follow alerts | — |
